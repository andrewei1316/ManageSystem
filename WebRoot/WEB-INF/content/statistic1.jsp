		...
		<div class="main-content">
			...
			<div class="panel panel-default">
				<div class="panel-heading">
					<form id="attName" name="attName" action="Statistics_new">	
						<script type="text/javascript">
						...
						<select id="attributeName" name="attributeName"  onchange="submit();" style="height: 36px;box-shadow: none;border: 1px solid #e4e4e4;">
							<option>请选择字段</option>
