...
<script type="text/javascript">
  ...
  <body class="page-body">
	...
	<div class="page-container"><!-- add class "sidebar-collapsed" to close sidebar by default, "chat-visible" to make chat appear always -->		
		...
		<form id = "updateUserForm" name = "updateUserForm" action = "UpdateUser" method = "post" class="form-horizontal">
  								<div class="form-group">
									<label class="col-sm-1 control-label">登录账号</label>
									
									<div class="col-sm-4">
										<input type="text" class="form-control" placeholder="Placeholder" id = "userLogId" name = "userLogId" value = "${currUser.userLogId }" disabled>
									</div>
								</div>
  								<div class="form-group">
									...
									<div class="col-sm-4">
										<input type="text" class="form-control" placeholder="Placeholder" id = "userName" name = "userName" value = "${currUser.userName }">
									</div>
								</div>
								<div class="form-group">
									...
									<div class="col-sm-4">
										<input type="password" class="form-control" id = "oldUserPsw" name = "oldUserPsw" placeholder="需要更改时填写">
									</div>
								</div>
								<div class="form-group">
									...
									<div class="col-sm-4">
										<input type="password" class="form-control" id = "newUserPsw" name = "newUserPsw" placeholder="需要更改时填写">
									</div>
								</div>
								<div class="form-group">
									...
									<div class="col-sm-4">
										<input type="password" class="form-control" id = "reNewUserPsw" name = "reNewUserPsw" placeholder="需要更改时填写">
									</div>
								</div>
  			
  								<input class="btn btn-primary btn-single btn-sm" type = "submit" value = "提交" onclick = "return Confirm()"/> 			
  		</form>
				</div>
			</div>
